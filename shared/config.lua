...
Config.Garages = {
    motelgarage = {
        ...
        spawnPoint = {vector4(265.96, -332.3, 44.51, 250.68)},
        showBlip = true,
    ...
    casinogarage = {
        ...
        spawnPoint = {vector4(895.39, -4.75, 78.35, 146.85)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    sapcounsel = {
        ...
        spawnPoint = {vector4(-341.57, -767.45, 33.56, 92.61)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    spanishave = {
        ...
        spawnPoint = {vector4(-1145.2, -745.42, 19.26, 108.22)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    caears24 = {
        ...
        spawnPoint = {vector4(60.8, 17.54, 68.82, 339.7)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    caears242 = {
        ...
        spawnPoint = {vector4(-472.39, -787.71, 30.14, 180.52)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    lagunapi = {
        ...
        spawnPoint = {vector4(375.09, 294.66, 102.86, 164.04)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    airportp = {
        ...
        spawnPoint = {vector4(-779.77, -2040.18, 8.47, 315.34)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    beachp = {
        ...
        spawnPoint = {vector4(-1188.14, -1487.95, 3.97, 124.06)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    themotorhotel = {
        ...
        spawnPoint = {vector4(1127.7, 2647.84, 37.58, 1.41)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    liqourparking = {
        ...
        spawnPoint = {vector4(898.38, 3649.41, 32.36, 90.75)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    shoreparking = {
        ...
        spawnPoint = {vector4(1725.4, 3716.78, 34.15, 20.54)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    haanparking = {
        ...
        spawnPoint = {vector4(62.15, 6403.41, 30.81, 211.38)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    dumbogarage = {
        ...
        spawnPoint = {vector4(168.34, -3236.1, 5.43, 272.05)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    grapeseedgarage = {
        ...
        spawnPoint = {vector4(2550.17, 4681.96, 33.81, 17.05)},
        showBlip = true,
        blipName = 'Public Parking',
        type = 'public',
        category = Config.VehicleClass['car']
    ...
    depotLot = {
        ...
        spawnPoint = {vector4(396.55, -1643.93, 28.88, 321.91)},
        showBlip = true,
        blipName = 'Depot Lot',
        type = 'depot',
        category = Config.VehicleClass['car']
    ...
    ballas = {
        ...
        spawnPoint = {vector4(93.78, -1961.73, 20.34, 319.11)},
        showBlip = false,
        blipName = 'Ballas',
        type = 'gang',
    ...
    families = {
        ...
        spawnPoint = {vector4(-25.47, -1445.76, 30.24, 178.5)},
        showBlip = false,
        blipName = 'Families',
        type = 'gang',
        category = Config.VehicleClass['car'], -- car, air, sea, rig
    ...
    lostmc = {
        ...
        spawnPoint = {vector4(977.65, -133.02, 73.34, 59.39)},
        showBlip = false,
        blipName = 'Lost MC',
        type = 'gang',
        category = Config.VehicleClass['car'], -- car, air, sea, rig
    ...
    cartel = {
        ...
        spawnPoint = {vector4(1403.01, 1118.25, 114.84, 88.69)},
        showBlip = false,
        blipName = 'Cartel',
        type = 'gang',
        category = Config.VehicleClass['car'],
    ...
    police = {
        ...
        spawnPoint = {vector4(446.16, -1025.79, 28.23, 6.59)},
        showBlip = false,
        blipName = 'Police',
        type = 'job',
        category = Config.VehicleClass['car'], -- car, air, sea, rig
    ...
    intairport = {
        ...
        spawnPoint = {vector4(-998.37, -2985.01, 13.95, 61.09)},
        showBlip = true,
        blipName = 'Hangar',
        type = 'public',
    ...
    airsshores = {
        ...
        spawnPoint = {vector4(1742.83, 3266.83, 41.24, 102.64)},
        showBlip = true,
        blipName = 'Hangar',
        type = 'public',
        category = Config.VehicleClass['air']
    ...
    airzancudo = {
        ...
        spawnPoint = {vector4(-1828.25, 2975.44, 32.81, 57.24)},
        showBlip = true,
        blipName = 'Hangar',
        type = 'public',
        category = Config.VehicleClass['air']
    ...
    airdepot = {
        ...
        spawnPoint = {vector4(-1270.01, -3377.53, 14.33, 329.25)},
        showBlip = true,
        blipName = 'Air Depot',
        type = 'depot',
        category = Config.VehicleClass['air']
    ...
    lsymc = {
        ...
        spawnPoint = {vector4(-796.64, -1502.6, -0.09, 111.49)},
        showBlip = true,
        blipName = 'Boathouse',
        type = 'public',
    ...
    rigdepot = {
        ...
        spawnPoint = {vector4(2324.57, 3117.79, 48.21, 4.05)},
        showBlip = true,
    ...
    dumborigparking = {
        ...
        spawnPoint = {vector4(167.0, -3203.89, 5.94, 271.27)},
        showBlip = true,
    ...
    popsrigparking = {
        ...
        spawnPoint = {vector4(127.69, 6605.84, 31.93, 223.67)},
        showBlip = true,
        blipName = 'Big Rig Parking',
        type = 'public',
        category = Config.VehicleClass['rig']
    ...
    ronsrigparking = {
        ...
        spawnPoint = {vector4(-2521.61, 2326.45, 33.13, 88.7)},
        showBlip = true,
        blipName = 'Big Rig Parking',
        type = 'public',
        category = Config.VehicleClass['rig']
    ...
    ronsrigparking2 = {
        ...
        spawnPoint = {vector4(2561.67, 476.68, 108.49, 177.86)},
        showBlip = true,
        blipName = 'Big Rig Parking',
        type = 'public',
        category = Config.VehicleClass['rig']
    ...
    ronsrigparking3 = {
        ...
        spawnPoint = {vector4(-39.39, -2527.81, 6.08, 326.18)},
        showBlip = true,
        blipName = 'Big Rig Parking',
        type = 'public',
        category = Config.VehicleClass['rig']
